...
document.getElementById('search-button').addEventListener('click', function() {
    ...
    document.getElementById("city-header").textContent = searchInput;
    ...
    fetch(searchApi)
        ...
        var weatherApi = `http://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=9efcb564494f2e20b99f73f7925ec30e`;
